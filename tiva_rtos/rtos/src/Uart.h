 ...
 * Name: Uart.h
 * Description:
 * -This header file contains declaration of UART related function
...
#define IBRD_115200 8   //baud rate integer part
#define FBRD_115200 44  //baud rate float part
...
#define OUTPUT_SERVER_MSGQ   254
#define INPUT_SERVER_MSGQ   255
#define TIME_SERVER_MSGQ 256    //msg queue number of time server
#define UART_INPUT_HANDLER  0
